...
const (
	...
	maxPatchRetry = 5
	// backOffPeriod is the period to back off when format patch results in error.
...
func newPatcher(o *FormatOptions, info *resource.Info, helper *resource.Helper) (*Patcher, error) {
